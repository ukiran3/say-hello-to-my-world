...
{	
	...
	public static ArrayList<Integer> makeArray(String str1)
	{
	...
	private static String addConstants(String str)
	{
		String[] s = str.split("[+]");
		Integer[] u = new Integer[20];
